...
class CustomerAdmin(BaseAdmin):
    list_display = [ 'name', 'qq', 'qq_name', 'referral_from', 'source', 'date']
    # model = models_class
...
def regist(model_class, admin_class=BaseAdmin):
...
regist(models.UserProfile, UserAdmin)
regist(models.Enrollment)
